...
class Part(pygame.sprite.Sprite):
    ...
    def __init__(self,group,color,x,y,dir):
        ...
        self.dir = dir #direction of motion - right:(1,0), left:(-1,0), down:(0,1), up:(0,-1)
...
class Snake(pygame.sprite.Sprite):
    ...
    #if move() went closer to x,y (which will be the coordinates of food), sets closer_to_food = 1 else 0
    def move(self,x,y):
    ...
    #Appends snake part to tail. Called when food eaten
